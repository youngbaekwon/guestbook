  ...
  stages {
    ...
    stage('K8S Manifest Update') {
        steps {
            ...
            sh "sed -i 's/k8s-guestbook:blue-.*\$/k8s-guestbook:blue-${currentBuild.number}/g' guestbook-rollout-bluegreen.yaml"
            sh "sed -i 's/k8s-guestbook:green-.*\$/k8s-guestbook:green-${currentBuild.number}/g' guestbook-rollout-bluegreen.yaml"
